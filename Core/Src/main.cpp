...
static void MX_TIM1_Init(void)
{
  ...
  /*начальнная уставка. частота тактирования таймера 100000Гц, Prescaler = 480;
   *минимальная частота 1.6 Гц,  максимальная 100000 Гц
   * 1/1,6 х 200 = 125с - время полного оборота на минималке
   * 1,6/200 х 60 = 0,48 об/мин
   */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : pin_kv22_Pin */
  GPIO_InitStruct.Pin = pin_kv22_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(pin_kv22_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : pin_kv11_Pin */
  GPIO_InitStruct.Pin = pin_kv11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
